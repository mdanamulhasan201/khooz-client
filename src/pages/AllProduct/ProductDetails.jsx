                        ...
                        <div className="grid grid-cols-1 xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                            <div>
                                <div className="p-5 border ">
                                    <img className="w-full h-[350px] " src={image ? `http://localhost:5173/images/products/${image}.jpg` : `http://localhost:5173/images/products/${images[1]}.jpg`} alt="" />
                                                ...
                                                images.map((img, i) => {
                                                    return (
                                                        <div key={i} className="pr-2 border cursor-pointer" onClick={() => setImage(img)}>
                                                            <img className="w-full h-[80px] hover:shadow-2xl hover:border-gray-950 hover:border" src={`http://localhost:5173/images/products/${img}.jpg`} alt="" />
                                                        </div>
                                                    )
                                                })
                                            }
                                                    ...
                                                    <Link className='block' key={i}>
                                                        <div key={products.id} className='border w-72 group transition-all duration-500 hover:shadow-md hover:-mt-3'>
                                                            <div className='relative overflow-hidden'>
                                                                ...
                                                                <img className='h-[240px]' src={`http://localhost:5173/images/products/1.jpg`} alt={products.name} />
