...
const navigation = [
  ...
  { name: 'All Provider', href: '#', current: false },
...
export default function Navbar() {
  ...
  return (
    <Disclosure as="nav" className={`fixed w-full z-10  ${isScrolled ? 'bg-[#F8F5FF] shadow-md' : ''}`}>
      {({ open }) => (
        <>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-red-500 hover:bg-red-400 text-white' : 'text-black hover:bg-red-300 hover:text-white',
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="space-y-1 bg-[#F8F5FF] px-2 pb-3 pt-2">
              {navigation.map((item) => (
                <Disclosure.Button
                  key={item.name}
                  as="a"
                  href={item.href}
                  className={classNames(
                    item.current ? 'bg-red-400 text-white' : 'text-black hover:bg-gray-700 hover:text-white',
